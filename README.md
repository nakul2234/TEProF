...
A useful feature that can be used is that the pipeline will annotate the first intron of each transcript. 
...
Once all the gtf files are generated the following steps can be used to obtain the annotations. We have designed this pipeline to be flexible, and thus we provide explainations for each intermediate file that can be used for more custom usage of our code. 
