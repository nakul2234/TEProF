...
plustab = tabix.open('/bar/nshah/reference/genecode_plus_hg38.tab.bgz')
minustab = tabix.open('/bar/nshah/reference/genecode_minus_hg38.tab.bgz')
...
with open("/bar/nshah/reference/TE.lst","r") as fin:
        for eachline in fin:
...
for eachline in fileinput.input():
    ...
    if strandfirst == "." or strandsecond == "." or strandfirst == strandsecond or qualityread < 60:
            continue
